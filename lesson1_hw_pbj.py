...
if slices == 2 and pb == 1 and jelly ==1:
    print "yay make a sandwich"
else: "looks like I don't have a lunch today"

if slices == even number and pb == slices/2 and jelly == slices/2:
    print "yay I can make slices/2 sandwhiches"
else: "I c
